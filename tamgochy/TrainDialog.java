...
//	}
	...
	public Reply reply(UserData user, String input) {
		...
		if ((input.equals("туалет")) || (input.equals("🚽")) && user.pet.trainLvl == 1) {
			user.pet.trainLvl += 1;
		...
		if ((input.equals("гигиена") || input.equals("мыться") || input.equals("мойся") || input.equals("💦")) && user.pet.trainLvl == 2) {
			user.pet.trainLvl += 1;
		...
		if (input.equals("спать") || input.equals("сон") || input.equals("спи") || input.equals("💤") && user.pet.trainLvl == 3) {
			user.pet.trainLvl += 1;
		...
		if (input.equals("питание") || input.equals("еда") || input.equals("ешь") || input.equals("покормить") ||
		...
		if ((input.equals("здоровье")) || (input.equals("жизни")) || (input.equals("💊")) && user.pet.trainLvl == 5) {
			user.pet.trainLvl += 1;
		...
		if (input.equals("да! ✨") && user.pet.trainLvl == 6) {
